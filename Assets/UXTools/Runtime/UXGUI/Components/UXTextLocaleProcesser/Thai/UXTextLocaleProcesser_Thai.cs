...
namespace UnityEngine.UI
{
    public class UXTextLocaleProcesser_Thai : UXTextLocaleProcesser
    {
        ...
        {
            LocalizationType = LocalizationTypeDef.thTH;
        }
        ...
        public override string GenLocaleRenderedString(string text)
        {
            ...
            OriginString = text;
            UnityEngine.Profiling.Profiler.BeginSample("LXText.CustomRefreshRenderedText.Thai");
        ...
        {
            UnityEngine.Profiling.Profiler.BeginSample("LXText.ThaiFontAdjust");
        ...
        {
            UnityEngine.Profiling.Profiler.BeginSample("LXText.ReadThaiDict");
        ...
        private string HandleThaiLineBreak(string text)
        {
            ...
            UnityEngine.Profiling.Profiler.BeginSample("LXText.HandleThaiLineBreak");
        ...
        private void HandleWordBreak()
        {
            ...
            UnityEngine.Profiling.Profiler.BeginSample("LXText.HandleWordBreak");
