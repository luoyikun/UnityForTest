...
namespace UnityEngine.UI
{
    ...
    public class UXImage : Image, ILocalization
    {
        ...
        public static readonly string[] suffix = new string[]{
            "CN", "TC", "EN", "JA", "KO", "FR", "DE", "ES", "RU", "TR", "PT", "VI", "TH", "AR"
        };
        ...
        {
            if (language >= 0 && sprite != null && !ignoreLocalization)
            {
                base.sprite = ResourceManager.Load<Sprite>(UXGUIConfig.LocalizationFolder + suffix[language] + "/" + origin_name + "_" + suffix[language]);
                if (sprite == null)
                {
                    base.sprite = ResourceManager.Load<Sprite>("need_replace");
                }
            }
        }
