...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/LXToggle", 47)]
    ...
    public class UXToggle : Selectable, IPointerClickHandler, ISubmitHandler, ICanvasElement
    {
        ...
        private void SetToggleGroup(LXToggleGroup newGroup, bool setMemberValue)
        {
            LXToggleGroup oldGroup = m_Group;
