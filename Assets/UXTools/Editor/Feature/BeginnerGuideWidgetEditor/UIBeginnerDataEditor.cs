...
namespace ThunderFireUITool
{
    ...
    {
        //SerializedProperty prevMode;
        SerializedProperty property;
        ReorderableList List;
        Func<SerializedProperty, float> getHeight;
        void OnEnable()
        {
            //prevMode = serializedObject.FindProperty("PreviewMode");
            ...
            List.onRemoveCallback = (ReorderableList l) =>
            {
                ...
                if (ok)
                {
                    ...
                    if (UIBeginnerGuideEditor.Instance.guideData != null &&
        ...
        public override void OnInspectorGUI()
        {
            ...
            //EditorGUILayout.PropertyField(prevMode);
    ...
    {
        [MenuItem("ThunderFireUXTool/创建新手引导(Create BeginnerGuide)")]
