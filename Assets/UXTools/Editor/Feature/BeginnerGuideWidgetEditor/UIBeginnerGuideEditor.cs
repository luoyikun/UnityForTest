...
namespace ThunderFireUITool
{
    ...
    public class UIBeginnerGuideEditor : UXSingleton<UIBeginnerGuideEditor>
    {
        ...
        private void InitEditableBeginnerGuide()
        {
        ...
        private void Preview()
        {
            ...
            PreviewLogic.PreviewGuide(guideRoot, guideData.guideID);
            //Task.Delay(2000).ContinueWith(BeginPreview);
        }
        // private void BeginPreview(Task tsk)
        // {
        //     Debug.Log(2);
        //     PreviewLogic.PreviewGuide();
        // }
    }
}
