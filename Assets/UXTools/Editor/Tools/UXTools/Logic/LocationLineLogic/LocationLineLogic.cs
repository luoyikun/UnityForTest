...
namespace ThunderFireUITool
{
    ...
    public class LocationLineLogic : UXSingleton<LocationLineLogic>
    {
        ...
        /// 按钮事件,创建一组横竖辅助线
        /// </summary>
        public void CreateLocationLine()
        {
            ...
            LocationLineData horzLineData = new LocationLineData()
            {
                Id = curId,
                Horizontal = true,
                Pos = worldPostion.y
            };
            LocationLineData vertLineData = new LocationLineData()
            {
                Id = curId + 1,
                Horizontal = false,
                Pos = worldPostion.x,
            ...
            LocationLine v = new VerticalLocationLine
            {
                id = vertLineData.Id,
                worldPostion = new Vector3(vertLineData.Pos, 0, 0)
            };
            LocationLine h = new HorizontalLocationLine
            {
                id = horzLineData.Id,
                worldPostion = new Vector3(0, horzLineData.Pos, 0)
            };

            PlaceLinesToSceneView(new List<LocationLine> { v, h });
        }
        ...
        private void LoadLocationLines()
        {
            ...
            m_LinesData = SettingAssetsUtils.GetAssets<LocationLinesData>();
