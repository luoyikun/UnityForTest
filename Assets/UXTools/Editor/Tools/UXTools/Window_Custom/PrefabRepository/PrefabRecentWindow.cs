...
namespace ThunderFireUITool
{
    public class PrefabRecentWindow : EditorWindow
    {
        ...
        [MenuItem("ThunderFireUXTool/最近打开 (Recent Opened)", false, 53)]
        ...
        {
            list = SettingAssetsUtils.GetAssets<PrefabOpenedSetting>();
        ...
        {
            if (UXSceneViewCursor.Instance.OutBounds(sceneView))
            {
                UXCustomSceneView.RemoveDelegate(DrawTexture);
            }
            Handles.BeginGUI();
