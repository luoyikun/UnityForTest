...
namespace ThunderFireUITool
{
    public class HierarchyManagementWindow : EditorWindow
    {
        ...
        private static List<TagColor> _mTagColors = new List<TagColor>();
        ...
        public static int maxPrefabNum = 0;
        ...
        public static List<ManagementLevel> GetManagementLevels()
        {
            return _managementLevels;
        }
        
        public static List<PrefabDetail> GetPrefabDetails()
        {
            return _prefabDetails;
        }
        ...
        public static void SetPrefabDetails(List<PrefabDetail> prefabDetails)
        {
            var prefabs = new List<PrefabDetail>(prefabDetails);
            _prefabDetails = prefabs;
            ...
            hierarchyManagementSetting.prefabDetailList = prefabs;
            HierarchyManagementEvent.Init();
        }
        
        public static void SetMaxPrefabNum(int number)
        {
            maxPrefabNum = number;
            var hierarchyManagementSetting = SettingAssetsUtils.GetAssets<HierarchyManagementSetting>();
            if (HierarchyManagementSetting.isDemo)
                hierarchyManagementSetting = AssetDatabase.LoadAssetAtPath<HierarchyManagementSetting>(
                    ThunderFireUIToolConfig.AssetsRootPath + "Samples/HierarchyManage/HierarchyManagementSettingDemo.asset");
            hierarchyManagementSetting.maxPrefabNum = maxPrefabNum;
            HierarchyManagementEvent.Init();
        }

        [MenuItem("ThunderFireUXTool/层级管理工具 (Hierarchy Manage)", false, 55)]
        public static void OpenWindow()
        {
            ...
            // _managementWindow.position = new Rect((Screen.currentResolution.width - windowWidth) / 2,
        ...
        private void InitWindowData()
        {
            ...
            if (HierarchyManagementSetting.isDemo)
                hierarchyManagementSetting = AssetDatabase.LoadAssetAtPath<HierarchyManagementSetting>(
                    ThunderFireUIToolConfig.AssetsRootPath + "Samples/HierarchyManage/HierarchyManagementSettingDemo.asset");
            hierarchyManagementSetting.CovertToSetting();
            // hierarchyManagementSetting.TestInit();
            ...
            _mTagColors = hierarchyManagementSetting.tagColors;
            maxPrefabNum = hierarchyManagementSetting.maxPrefabNum;
        ...
        {
            HierarchyManagementSetting.isDemo = false;
            if (!_refreshFlag) return;
            _refreshFlag = false;
                    ...
                    EditorLocalization.GetLocalization(EditorLocalizationStorage.Def_保存),EditorLocalization.GetLocalization(EditorLocalizationStorage.Def_不保存)))
            {
                ...
                if (HierarchyManagementSetting.isDemo)
                    hierarchyManagementSetting = AssetDatabase.LoadAssetAtPath<HierarchyManagementSetting>(
                        ThunderFireUIToolConfig.AssetsRootPath + "Samples/HierarchyManage/HierarchyManagementSettingDemo.asset");
                hierarchyManagementSetting.CovertToList();
            }
        }
        ...
        private void DrawWindowUI()
        {
            ...
            _searchContent = UXBuilder.Div(root, new UXBuilderDivStruct()
            {
                style = new UXStyle()
                {
                    height = 34, width = Length.Percent(100),
                    borderBottomColor = Color.black, borderBottomWidth = 2,
                    paddingTop = 6, paddingLeft = 18, paddingBottom = 6, paddingRight = 18,
        ...
        private void DrawSearch(VisualElement rowSearch)
        {
            UXBuilder.Text(rowSearch, new UXBuilderTextStruct()
            {
                ...
                style = new UXStyle()
                {
                    height = 20, marginRight = 6, fontSize = 14, unityTextAlign = TextAnchor.MiddleCenter,
                    color = Color.white,
                }
            });
            ...
            var search = UXBuilder.Input(rowSearch, new UXBuilderInputStruct()
            {
                style = new UXStyle()
                {
                    height = 20,
                    width = 158,
                    marginBottom = Length.Percent(0), marginLeft = Length.Percent(0),
                    marginRight = Length.Percent(0), marginTop = Length.Percent(0),
                    fontSize = 12,
                    color = Color.white,
                },
                onChange = s =>
            ...
            {
                align = Align.Center, justify = Justify.FlexEnd,
                style = new UXStyle()
                {
                    height = 20, width = 90, backgroundColor = _mSearchBlack,
                    borderTopRightRadius = 3, borderBottomRightRadius = 3, paddingRight = 6,
                    borderRightWidth = 1, borderTopWidth = 1, borderBottomWidth = 1,
                    borderRightColor = Color.black, borderTopColor = Color.black, borderBottomColor = Color.black,
                }
            });
            ...
            if (!string.IsNullOrEmpty(_searchText))
            {
                if (_searchList.Count != 0)
                {
                    UXBuilder.Button(visualElement, new UXBuilderButtonStruct()
                    {
                        ...
                        style = new UXStyle()
                        {
                            fontSize = 12, marginLeft = 6, paddingLeft = Length.Percent(0),
                            paddingRight = Length.Percent(0), color = Color.white, 
                            paddingTop = Length.Percent(0),paddingBottom = Length.Percent(0),
                            marginTop = Length.Percent(0),marginBottom = Length.Percent(0),
                        },
                        OnClick = () =>
                        {
                ...
                _searchResultText = UXBuilder.Text(visualElement, new UXBuilderTextStruct()
                {
                    ...
                    style = new UXStyle()
                    {
                        fontSize = 12, unityTextAlign = TextAnchor.MiddleLeft,
                ...
                if (_searchList.Count != 0)
                {
                    UXBuilder.Button(visualElement, new UXBuilderButtonStruct()
                    {
                        ...
                        style = new UXStyle()
                        {
                            fontSize = 12, paddingLeft = Length.Percent(0),
                            paddingRight = Length.Percent(0), color = Color.white,
                            paddingTop = Length.Percent(0),paddingBottom = Length.Percent(0),
                        },
                        OnClick = () =>
        ...
        private void DrawTopButtons(VisualElement rowTop)
        {
            var topButtonContent = UXBuilder.Row(rowTop, new UXBuilderRowStruct()
            {
                ...
                style = new UXStyle()
                {
                    height = Length.Percent(100), width = Length.Percent(40),
                    position = Position.Absolute, right = Length.Percent(0),
                }
            });
            ...
            UXBuilder.Button(topButtonContent, new UXBuilderButtonStruct()
            {
                ...
                style = new UXStyle()
                {
                    height = 20, width = 78, marginRight = 6, marginLeft = Length.Percent(0)
                },
                text = EditorLocalization.GetLocalization(EditorLocalizationStorage.Def_添加Prefab),
                disabled = _managementLevels.Count == 0,
                OnClick = () =>
                {
                    var level = _managementLevels[0];
            ...
            */
            ...
            UXBuilder.Button(topButtonContent, new UXBuilderButtonStruct()
            {
                ...
                style = new UXStyle()
                {
                     height = 20, width = 54, marginRight = Length.Percent(0), marginLeft = Length.Percent(0)
                },
        ...
        private void DrawRangeRefresh(VisualElement topButtonContent)
        {
            var input = UXBuilder.Input(topButtonContent, new UXBuilderInputStruct()
            {
                style = new UXStyle()
                {
                    height = 25, width = 40, marginRight = 5
                },
            });
            input.value = _range.ToString();
            ...
            UXBuilder.Button(topButtonContent, new UXBuilderButtonStruct()
            {
                style = new UXStyle()
                {
                    height = 30, width = 40, marginRight = 5
                },
                ...
                OnClick = () =>
                {
                    ...
                    {
                        hierarchyManagementSetting.range = num;
                        HierarchyManagementEvent.Init();
                    }
                    InitWindowData();
                    DrawWindowUI();
        ...
        private void DrawTitles()
        {
            var rowTitle = UXBuilder.Div(_scrollView, new UXBuilderDivStruct()
            {
                ...
                style = new UXStyle()
                {
                    ...
                    width = _managementChannels.FindAll(s => s.LevelIDList.Count > 0).Count * SpaceWidth +
                            _managementLevels.Count * (SingleWidth + SpaceWidth),
                    borderBottomWidth = BorderWidth, borderBottomColor = _mBorderGrey,
                }
            });
            foreach (var channel in _managementChannels)
            {
                ...
                var div = UXBuilder.Div(rowTitle, new UXBuilderDivStruct()
                {
                    style = new UXStyle()
                    {
                        ...
                        height = Length.Percent(100),
                        borderRightWidth = _managementChannels.Count > 0 &&
                                           channel == _managementChannels[_managementChannels.Count - 1]
                            ? 0
                            : BorderWidth,
                ...
                var text = UXBuilder.Text(div, new UXBuilderTextStruct()
                {
                    style = new UXStyle()
                    {
                        width = Length.Percent(80), height = 48,
                        fontSize = 24,
        ...
        private void DrawLevelsForSingleChannel(ManagementChannel channel, VisualElement visualElement)
        {
            var div = UXBuilder.Div(visualElement, new UXBuilderDivStruct()
            {
                style = new UXStyle()
                {
                    width = Length.Percent(100), height = Length.Percent(60), flexDirection = FlexDirection.Row,
                    flexWrap = Wrap.NoWrap, justifyContent = Justify.Center, alignItems = Align.Center,
                }
            });
            foreach (var levelID in channel.LevelIDList)
            {
                var level = _managementLevels[levelID];
                var levelDiv = UXBuilder.Text(div, new UXBuilderTextStruct()
                {
                    style = new UXStyle()
                    {
                        marginLeft = SpaceWidth, width = SingleWidth, backgroundColor = _mRed,
                        marginRight =
                    ...
                    // text = level.Index + "",
                    text = channel.ID * _range + channel.LevelIDList.IndexOf(levelID) + "",
                });
                levelDiv.RegisterCallback<MouseDownEvent>(evt =>
                {
                    ...
                    */
                    menu.AddItem(new GUIContent(EditorLocalization.GetLocalization(EditorLocalizationStorage.Def_向前添加层级)),
                        false, () =>
                        {
                            var list = _managementChannels[level.ChannelID].LevelIDList;
                            if(list.IndexOf(level.ID) == 0 && level.Index == level.ChannelID * _range)
                                HierarchyManagementEvent.AddLevel(level, level.Index);
                            else if(level.ID == 0 || _managementLevels[level.ID - 1].Index != level.Index - 1)
                    ...
                    menu.AddItem(new GUIContent(EditorLocalization.GetLocalization(EditorLocalizationStorage.Def_向后添加层级)),
                        ...
                        {
                            var list = _managementChannels[level.ChannelID].LevelIDList;
                            if(list.IndexOf(level.ID) == list.Count - 1 && level.Index + 1 == (level.ChannelID + 1) * _range)
        ...
        private void DrawContent()
        {
            var rowContent = UXBuilder.Row(_scrollView, new UXBuilderRowStruct()
            {
                style = new UXStyle()
                {
                    ...
                    top = SpaceHeight + SinglePrefabHeight * 0.5f + 48 + BorderWidth, bottom = Length.Percent(0),
                    // backgroundColor = Color.green,
                    // overflow = Overflow.Visible,
                    width = _managementChannels.FindAll(s => s.LevelIDList.Count > 0).Count * SpaceWidth +
                            _managementLevels.Count * (SingleWidth + SpaceWidth) + 13,
                }
            });
        ...
        {
            if(!_firstFlag) _refreshFlag = true;
            _firstFlag = false;
            _chosenFlag = true;
            ...
            foreach (var channel in _managementChannels)
            {
                ...
                foreach (var levelID in channel.LevelIDList)
                {
                    ...
                    var prefabsDiv = UXBuilder.Div(div, new UXBuilderDivStruct()
                    {
                        ...
                        style = new UXStyle()
                        {
                            marginLeft = SpaceWidth, width = SingleWidth,
        ...
        private void DrawPrefabsForSingle(ManagementLevel level, VisualElement visualElement)
        {
            ...
            foreach (var prefabDetailID in level.PrefabDetailIDList)
            {
                ...
                var prefabDetail = _prefabDetails[prefabDetailID];
                var color = _searchList.Find(s=> s.ID == prefabDetail.ID) != null ? _mYellow : _mGrey;
                if(!flag)
                ...
                var prefabDiv = UXBuilder.Text(visualElement, new UXBuilderTextStruct()
                {
                    style = new UXStyle()
                    {
                        borderBottomWidth = flag ? 3 : 0, borderTopWidth = flag ? 3 : 0,
                        borderLeftWidth = flag ? 3 : 0, borderRightWidth = flag ? 3 : 0,
                        ...
                        width = Length.Percent(100), height = SinglePrefabHeight, backgroundColor = color,
                        unityTextAlign = TextAnchor.MiddleCenter,overflow = Overflow.Hidden, 
                        whiteSpace = WhiteSpace.NoWrap,
                        fontSize = 16,
                        paddingLeft = Length.Percent(0), paddingRight = Length.Percent(0),
                ...
                prefabDiv.RegisterCallback<MouseDownEvent>(evt =>
                {
                    ...
                    if (evt.button == 0)
                    {
                        ...
                        _prefabDrag = UXBuilder.Text(rootVisualElement, new UXBuilderTextStruct()
                        {
                            ...
                            style = new UXStyle()
                            {
                                width = SingleWidth, height = SinglePrefabHeight, backgroundColor = _mGrey,
                                unityTextAlign = TextAnchor.MiddleCenter, overflow = Overflow.Hidden,
                                whiteSpace = WhiteSpace.NoWrap,
                                fontSize = 16,
                                paddingLeft = Length.Percent(0), paddingRight = Length.Percent(0),
                ...
                prefabDiv.RegisterCallback<MouseEnterEvent>(evt =>
                {
                    ...
                    {
                        className = "PrefabTooltip",align = Align.Center, justify = Justify.Center,
                        style = new UXStyle()
                        {
                            // height = height,
                            width = width,
                    ...
                    {
                        align = Align.Center, justify = Justify.FlexStart,
                    ...
                    {
                        var tagName = it.Name;
                        if (_mTagColors.Find(s => s.Name == tagName) == null)
                            _mTagColors.Add(new TagColor() { Name = tagName, Color = Color.black, });
                        var tagColor = _mTagColors.Find(s => s.Name == tagName).Color;
                    ...
                    UXBuilder.Div(ve, new UXBuilderDivStruct()
                    {
                        style = new UXStyle()
                        {
                            borderBottomColor = Color.white, borderBottomWidth = 1, height = 1, marginTop = 6,
                            marginBottom = 6
                        }
                    });
        ...
        private void DrawTagDetail(PrefabDetail prefabDetail, VisualElement visualElement, List<TagDetail> tagsls)
        {
            ...
            {
                justify = Justify.FlexStart, align = Align.FlexEnd,
                style = new UXStyle()
                {
                    height = Length.Percent(100), flexWrap = prefabDetail.Tags.Count < 6 ? Wrap.Wrap : Wrap.WrapReverse
                }
            });
            foreach (var tag in tagsls)
            {
            ...
            foreach (var tag in prefabDetail.Tags)
            {
                if (tagsls.Contains(tag))
                {
                    ...
                    if (_mTagColors.Find(s => s.Name == t.Name) == null)
                    {
                        _mTagColors.Add(new TagColor()
                        {
                            Color = Color.black,
                            Name = t.Name,
                        });
                    }
                    var color = _mTagColors.Find(s => s.Name == t.Name).Color;
                    var text = UXBuilder.Text(row, new UXBuilderTextStruct()
                    {
                        text = t.Num.ToString(),
                        style = new UXStyle()
                        {
                            width = 20, height = 10, backgroundColor = color, color = Color.white, fontSize = 10
                        }
                    });
                    text.tooltip = t.Name;
                }
        ...
        private void DrawLineVertical(Vector2 point1, Vector2 point2)
        {
            ...
            var div = UXBuilder.Div(_lineContent, new UXBuilderDivStruct()
            {
                style = new UXStyle()
                {
                    position = Position.Absolute, left = start.x, top = start.y,
                    height = end.y - start.y, width = 2,
        ...
        private void DrawSlantLine(Vector2 point1, Vector2 point2)
        {
            ...
            var div = UXBuilder.Div(_lineContent, new UXBuilderDivStruct()
            {
                style = new UXStyle()
                {
                    position = Position.Absolute, left = from.x, top = from.y,
                    height = 2, width = w,
                    backgroundColor = _mLineRed,
                }
            });
        ...
        public void Search(string s, VisualElement resultDiv)
        {
            ...
            foreach (var prefabDetail in _prefabDetails)
            {
                var path = Path.GetFileNameWithoutExtension(
                    AssetDatabase.GUIDToAssetPath(prefabDetail.Guid));
                var prefabName = string.IsNullOrEmpty(path) ? prefabDetail.Guid : path;
