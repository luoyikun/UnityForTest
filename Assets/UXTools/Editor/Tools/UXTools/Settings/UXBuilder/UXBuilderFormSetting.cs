...
namespace ThunderFireUITool
{
    ...
    {
        // [MenuItem("ThunderFireUXTool/新建配置文件 (Create Assets)/UXBuilderFormSetting")]
        public static void Create()
        {
            ...
            var assetPath = ThunderFireUIToolConfig.PrefabSettingsPath + "UXBuilderFormSetting.asset";
