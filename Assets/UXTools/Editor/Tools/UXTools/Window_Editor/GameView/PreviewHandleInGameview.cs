...
namespace ThunderFireUITool
{
    ...
    public class PreviewHandleInGameView
    {
        ...
        static void PlayModeStateChanged(PlayModeStateChange obj)
        {
            ...
            {
                Hide();
                if (PlayerPrefs.GetString("previewStage").Equals("true"))
                {
                    string prefabPath = PlayerPrefs.GetString("PreviewPrefabPath");
                    string OriginScenePath = PlayerPrefs.GetString("OriginScenePath");
                    Utils.StopPlayMode();
