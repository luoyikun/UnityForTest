...
namespace ThunderFireUITool
{
    ...
    {
        public static List<FileInfo> GetPrefabList()
        {
            ...
            PrefabSettledSetting list = SettingAssetsUtils.GetAssets<PrefabSettledSetting>();
        ...
        {
            //先修改 所有prefab中的label
            List<FileInfo> prefabInfoList = PrefabUtils.GetPrefabList();
            ...
            //再修改setting中的label数据
            var labelSetting = SettingAssetsUtils.GetAssets<PrefabLabelsSettings>();
